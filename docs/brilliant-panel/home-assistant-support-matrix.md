...
| Native HA light tile on a physical slider | **Source-eligible; live blocked** | Three stale physical-Control-owned HA `LIGHT` records were offered as assignable targets in the Office slider UI, but were not bound or operated. No official VC/light exists yet, so VC admission, online routing, binding, persistence, and cleanup gates remain. See [slider feasibility](slider-bridge-feasibility.md). |
