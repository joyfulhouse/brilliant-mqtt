...
were visible on the ordinary Backyard room screen, not in the slider picker.
This live-confirms native light rendering plus room placement for the deprecated
ownership model. It does not confirm a Virtual Control, slider-picker
eligibility, command routing, or HA feedback.
